...
{
    public class UkrskladDB4 : IUkrskladDB, IDisposable
    {
        private FbConnection connection;

        public UkrskladDB4(string host, string databaseLocation, bool isLocal) {
        ...
        private void setTotalForClient(int clientID, decimal total)
        {
            ...
            string updateSQL = string.Format(updateClientSuma, sum, clientID);
